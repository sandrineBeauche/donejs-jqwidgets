# Contributing to donejs-jqwidgets

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/sandrineBeauche/donejs-jqwidgets) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork donejs-jqwidgets, you can start by going to its [fork page](https://github.com/sandrineBeauche/donejs-jqwidgets/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/donejs-jqwidgets
```
